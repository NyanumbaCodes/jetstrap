...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    protected function basicInertiaTests()
    {
        ...
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/ActionMessage.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/ActionSection.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/ApplicationLogo.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/ApplicationMark.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Banner.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Button.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/ConfirmationModal.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Checkbox.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/DangerButton.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/DialogModal.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Dropdown.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/DropdownLink.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/FormSection.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Input.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/InputError.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Label.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Modal.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/NavLink.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/SecondaryButton.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/SectionBorder.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/SectionTitle.vue')));
        $this->assertTrue($this->filesystem->exists(resource_path('js/Components/Welcome.vue')));
